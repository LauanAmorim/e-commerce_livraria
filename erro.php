	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-4 text-center">
				...
				<a href="formlogin.php" class="btn btn-block btn-info" role="button">Tentar Novamente</a>
				
				<a href="formusuario.php" class="btn btn-block btn-primary" role="button">Ainda não sou cadastrado</a>
